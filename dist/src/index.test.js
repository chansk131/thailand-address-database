import { searchAddressByAmphoe, searchAddressByProvince, searchAddressByTambon, searchAddressByZipcode, } from "./index";
describe("More then 1 zipcode District", function () {
    it("District ปราณบุรี have 2 result", function () {
        ...
        expect(result.filter((item) => item.province === "ประจวบคีรีขันธ์").length).toBe(2);
    });
